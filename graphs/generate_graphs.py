...
def main():
    ...
    # data to plot
    # n_groups = 3
    # means_osc = (osc_wan_recv_pi_test1_avg, osc_lan_recv_pi_test1_avg)
    # means_udp = (udp_wan_recv_pi_test1_avg, udp_lan_recv_pi_test1_avg)
    # means_coap = (coap_wan_recv_pi_test1_avg, coap_lan_recv_pi_test1_avg)
